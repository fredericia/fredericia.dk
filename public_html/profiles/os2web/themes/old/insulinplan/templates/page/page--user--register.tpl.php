              ...
              <div class="table-row">
                <div class="table-cell">
                  <div class="os2-screen-content os2-screen-content-limited-width">
                    ...
                    <h1><?php print t('Become our member!'); ?></h1>

                    <!-- Begin - form -->
                    <?php if ($user_register_form = drupal_get_form('user_register_form')): ?>
                      <?php print render($user_register_form); ?>
                    <?php endif ?>
                    <!-- End - form -->

                    <!-- Begin - sign up -->
                    <?php print l(t('You can also sign in instead'), 'user/login'); ?>
                    <!-- End - sign up -->
