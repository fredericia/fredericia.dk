...
<article id="node-<?php print $node->nid; ?>" 
  class="<?php print $classes . " all"; ?> clearfix"<?php print $attributes; ?> 
  date-filter="<?php if (isset($top_parent_term)) print $top_parent_term ?>">

<?php if (arg(0) == 'taxonomy' && arg(1) == 'term' && arg(2) !== '6977'): ?>
...
<?php else: ?>
    ...
    <div class="front-s-news-item front-s-news-item-">
            <div class="front-s-news-item-text clearfix row">
                ...
                <div class="col-sm-10 col-md-11 col-xs-10 view-id-job_liste">
